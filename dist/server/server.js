...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DW6q4YG_.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BbxO0Be2.js").then((n) => n.r);
  const startEntry = await import("./assets/start-CyghrzsL.js");
